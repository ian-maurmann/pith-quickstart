...
$config_profile = $php_di_container->get('\\Pith\\Quickstart\\QuickstartConfig');    // <--- Replace this with your own Config Profile object.
$route_list     = $php_di_container->get('\\Pith\\Quickstart\\QuickstartRouteList'); // <--- Replace this with your own Route List object.
// ------------------
...
// ------------------
$monolog        = new \Monolog\Logger('PithQuickstart');
